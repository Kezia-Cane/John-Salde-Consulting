...
export const metadata: Metadata = {
    title: "About | John Salde Consulting",
    description:
        "Learn about John Salde Consulting: mission, vision, and values that guide the work.",
};
            ...
            >
                ...
                >
                    <div style={{ maxWidth: "780px" }}>
                        <span className="page-label" style={{ color: "var(--color-accent)" }}>About</span>
                        <h1
                    ...
                    >
                        ...
                        <h3 style={{ color: "white", marginBottom: "0.5rem", fontSize: "1.1rem" }}>Simple Strategy</h3>
                ...
                <div className="container" style={{ position: 'relative', zIndex: 2 }}>
                    ...
                    >
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                            <h2 className="text-h2" style={{ color: "var(--color-primary)" }}>Mission</h2>
                        ...
                        >
                            ...
                            <h2 className="text-h2" style={{ color: "var(--color-primary)", marginBottom: "2rem" }}>Vision</h2>
            ...
            <section className="section" style={{ backgroundColor: "#f8f9ff", position: 'relative', overflow: 'hidden' }}>
                ...
                <div className="container" style={{ position: 'relative', zIndex: 2 }}>
                    <div style={{ textAlign: "center", marginBottom: "4rem" }}>
                        <h2 className="text-h2" style={{ color: "var(--color-primary)", marginBottom: "1rem" }}>Core Values</h2>
                    ...
                    <div className="grid gap-8" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))" }}>
                        ...
                        >
                            <div>
                                ...
                                <h3 style={{ color: "var(--color-primary)", marginBottom: "1rem", fontSize: "1.5rem" }}>Clear Numbers</h3>
                        ...
                        >
                            ...
                            <h3 style={{ color: "var(--color-primary)", marginBottom: "0.75rem", fontSize: "1.25rem" }}>Coaching First</h3>
                            <p className="text-body-md" style={{ color: "var(--color-text-muted)" }}>
                        ...
                        >
                            ...
                            <h3 style={{ color: "white", marginBottom: "0.75rem", fontSize: "1.25rem" }}>Consistent Operations</h3>
                            <p className="text-body-md" style={{ color: "rgba(255,255,255,0.8)" }}>
                        ...
                        >
                            <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
                                <div style={{ flex: 1 }}>
                                    ...
                                    <h3 style={{ color: "var(--color-primary)", marginBottom: "0.75rem", fontSize: "1.5rem" }}>Healthy Profit</h3>
