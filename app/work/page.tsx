...
export const metadata: Metadata = {
    title: "Work | John Salde Consulting",
    description:
        "Real results and client work for coffee and food businesses.",
};
            ...
            >
                ...
                >
                    <div style={{ maxWidth: "700px" }}>
                        <span className="page-label" style={{ color: "var(--color-accent)" }}>Work</span>
                        <h1
                            className="text-display-md"
                            style={{ color: "white", lineHeight: 1.1, marginBottom: "1.5rem", textShadow: "0 2px 20px rgba(0,0,0,0.3)" }}
                        >
                            Real Results for Cafes.
                        </h1>
                        <p className="text-body-lg" style={{ maxWidth: "580px", color: "rgba(255,255,255,0.85)" }}>
                            A selection of client work focused on stronger operations and steady profit growth.
                        </p>
                    </div>
            ...
            <section className="section" style={{ position: "relative", overflow: "hidden", backgroundColor: "#ffffff" }}>
                ...
                <div className="container" style={{ position: "relative", zIndex: 2 }}>
                    <div style={{ display: "flex", flexDirection: "column", gap: "1rem", marginBottom: "3rem" }}>
                        <h2 className="text-h2" style={{ color: "var(--color-primary)" }}>Current Work</h2>
