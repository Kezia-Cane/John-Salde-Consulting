...
export const metadata: Metadata = {
    title: "Experience | John Salde Consulting",
    description:
        "Real-world experience in café growth, operations, and systems.",
};
        ...
        <main>
            ...
            <section className="page-hero" style={{ paddingBottom: "5rem", position: "relative", overflow: "hidden", backgroundColor: "var(--color-primary)" }}>
                ...
                >
                    {/* Left: text */}
                    <div>
                        <span className="page-label" style={{ color: "var(--color-accent)" }}>Experience</span>
                        <h1
                            className="text-display-md"
                            style={{ color: "white", lineHeight: 1.1, marginBottom: "1.5rem" }}
                        >
                            Practical Experience for Coffee Businesses.
                        </h1>
                        <p className="text-body-lg" style={{ color: "rgba(255,255,255,0.85)", maxWidth: "480px", marginBottom: "2rem" }}>
                            Clear, hands-on support for growth, operations, and consistent quality.
                        </p>
                        {/* Stat badge */}
                        <div
                        ...
                        >
                            ...
                            <span className="page-label" style={{ margin: 0, color: "#1D3B91", opacity: 0.75 }}>Years of Experience</span>
                        </div>
                    </div>
            ...
            <section className="section" style={{ textAlign: "center", position: "relative", overflow: "hidden" }}>
                ...
                <div className="container" style={{ maxWidth: "640px", position: "relative", zIndex: 2 }}>
                    ...
                    <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
                        ...
                        <Link href="/work" className="btn btn-secondary">View Work</Link>
                    </div>
                </div>
            </section>
